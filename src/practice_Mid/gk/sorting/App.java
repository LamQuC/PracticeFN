...
public class App {
    public static void main(String[] args) {
        ...
        int countArr = practice_Mid.HK2223.de2hk1giai.Giải.sortstrategy.SortStrategy.getInstance().sort(arr);
        ...
        int countArr1 = practice_Mid.HK2223.de2hk1giai.Giải.sortstrategy.SortStrategy.getInstance().sort(arr1);
