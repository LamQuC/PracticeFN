package hk2_2324_giai.de2.matrix;
...
public class MatrixTestDrive {
    public static void main(String[] args) {
        ...
        int n = rand.nextInt(6) + 5; // random number in [5,10]
        ...
        System.out.println("Principal Diagonal Matrix 1: " + Arrays.toString(m1.principalDiagonal()));
        System.out.println("Secondary Diagonal Matrix 1: " + Arrays.toString(m1.secondaryDiagonal()));

        System.out.println("Principal Diagonal Matrix 2: " + Arrays.toString(m2.principalDiagonal()));
        System.out.println("Secondary Diagonal Matrix 2: " + Arrays.toString(m2.secondaryDiagonal()));
        ...
        System.out.println("Gaussian Elimination of Matrix 1:");
        System.out.println(m1.gaussianElimination());

        System.out.println("Gaussian Elimination of Matrix 2:");
